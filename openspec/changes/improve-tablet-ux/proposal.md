...
- Affected client tests covering responsive tablet layouts, touch-friendly controls, immediate completion feedback, and parity between desktop and tablet behavior.
