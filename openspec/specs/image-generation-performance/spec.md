# image-generation-performance Specification

## Purpose
Define performance-oriented behavior for non-blocking instructional image generation, visible pending states, and progressive image loading.
