# openai-image-generation Specification

## Purpose
Define the server-side OpenAI image generation behavior used to create celebratory completion imagery without exposing credentials to the client.
